class DropBoxController {
    ...
    connectFirebase() {
        var config = {
            ...
            apiKey: "AIzaSyDPHse6YIaBAXxp36bHhaWA9nB_FmQ4hHE",

            authDomain: "drop-box-clone-b9599.firebaseapp.com",

            databaseURL: "https://drop-box-clone-b9599-default-rtdb.firebaseio.com",

            projectId: "drop-box-clone-b9599",

            storageBucket: "drop-box-clone-b9599.appspot.com",

            messagingSenderId: "412317524839",

            //appId: "1:412317524839:web:ae009e4758227361d145c2",

            //measurementId: "G-C0QZS33Z1W"
        ...
        return new Promise((resolve, reject) => {
            ...
            folderRef.on('value', snapshot => {
                ...
                snapshot.forEach(item => {
                    ...
                    if (data.type === 'folder' || data.mimetype === 'folder') {
                    ...
                    } else if (data.type || data.mimetype) {
    ...
    getFirebaseRef(path, filepath) {
        ...
        try {
            ...
            if (!filepath) path = this.currentFolder.join('/')
    ...
    getFileView(file, key) {
        ...
        <div class="name text-center">${file.originalFilename || file.name}</div>
      `;
    ...
    initEventsLi(li) {
        ...
        li.addEventListener('dblclick', e => {
            ...
            switch (file.type || file.mimetype) {
                case 'folder':
                    this.currentFolder.push(file.name || file.originalFilename)
                    this.openFolder()
                    break;
